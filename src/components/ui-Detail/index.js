...
class Detail extends Component {
  ...
  render () {
    ...
    let cover = {
      backgroundImage: 'url(https://static.pexels.com/photos/6368/art-wall-brush-painting.jpg)'
    }
    ...
    return (
      <article className='Detail'>
        ...
        <div className='Detail__content'>
          <h2>Normalcy and Subnormalcy</h2>
          ...
          <h4>Normalcy and Disabled People</h4>
          ...
          <h4>From normal to beyond normal to beyond species-typicality</h4>
